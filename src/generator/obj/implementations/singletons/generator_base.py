...
class GeneratorBase(metaclass=Singleton):
    def __init__(self):
        ...
        self._banned_op_codes: List[str] = GENERATOR_CONFIG["BANNED_OPERATORS_CODES"]
        self._prefix_data: PrefixData = GENERATOR_CONFIG["PREFIX_DATA"]
        self._start_with_landline: bool = GENERATOR_CONFIG["START_WITH_LANDLINE_OPERATORS_CODES"]
